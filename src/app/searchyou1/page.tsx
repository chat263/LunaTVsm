          ...
          <form onSubmit={handleSearch} className='max-w-2xl mx-auto'>
            <div className='relative group'>
              ...
              <input
                ...
                placeholder={searchType === 'video' ? '🎬 搜索电影、电视剧...' : searchType === 'netdisk' ? '💾 搜索网盘资源...' : searchType === 'youtube' ? '📺 搜索YouTube1视频...' : '🎭 搜索演员姓名...'}
                autoComplete="off"
                    ...
                    <div className='space-y-4'>
                      <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 dark:bg-blue-900/20 dark:border-blue-800'>
                        <div className='flex items-center text-blue-800 dark:text-blue-200 mb-2'>
                          ...
                          <span className='font-medium'>💡 直接播放YouTube1视频</span>
                        </div>
                        <p className='text-blue-700 dark:text-blue-300 text-sm'>
                          粘贴任意YouTube1链接，无需搜索即可直接播放视频。支持所有常见的YouTube1链接格式。
                        </p>
                      </div>
                      <DirectYouTubePlayer />
                    </div>
                ...
                <section className='mb-12'>
                  ...
                  {youtubeMode === 'direct' ? (
                    ...
                    <div className='text-center text-gray-500 py-8 dark:text-gray-400'>
                      ...
                      <p className='text-sm'>开始搜索YouTube1视频</p>
                    </div>
                  )}
                </section>
              )}
